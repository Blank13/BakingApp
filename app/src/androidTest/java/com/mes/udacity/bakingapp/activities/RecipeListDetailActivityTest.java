...
public class RecipeListDetailActivityTest {
    ...
    @Test
    public void recipeListDetailActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.recipe_detail_text), withText("Ingredients"),
                        isDisplayed()));
        textView.check(matches(withText("Ingredients")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.recipe_detail_text), withText("Recipe Introduction"),
                        isDisplayed()));
