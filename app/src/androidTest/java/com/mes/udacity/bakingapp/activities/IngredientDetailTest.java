...
public class IngredientDetailTest {
    ...
    @Test
    public void ingredientDetailTest() {
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.ingredient_quantity), withText("2.0"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        2),
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("2.0")));

        ViewInteraction textView4 = onView(
                allOf(withId(R.id.ingredient_name), withText("unsalted butter, melted"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        0),
                                1),
                        isDisplayed()));
        textView4.check(matches(withText("unsalted butter, melted")));
